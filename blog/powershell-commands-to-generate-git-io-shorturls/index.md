...
{{<img src="/images/gitio.png" width="660">}}
...
BTW, if you are using GistPad VS Code extension, you may want to [upvote this feature request](https://github.com/vsls-contrib/gistpad/issues/168) to add an option to copy the GitHub shorturl for the gists.
